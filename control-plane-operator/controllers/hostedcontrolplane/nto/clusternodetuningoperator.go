...
func ReconcileDeployment(dep *appsv1.Deployment, params Params) error {
	...
	dep.Spec.Template.Spec.Volumes = []corev1.Volume{
		{Name: "node-tuning-operator-tls", VolumeSource: corev1.VolumeSource{Secret: &corev1.SecretVolumeSource{SecretName: "node-tuning-operator-tls", DefaultMode: utilpointer.Int32Ptr(0640)}}},
		...
		{Name: "hosted-kubeconfig", VolumeSource: corev1.VolumeSource{Secret: &corev1.SecretVolumeSource{SecretName: manifests.KASServiceKubeconfigSecret("").Name, DefaultMode: utilpointer.Int32Ptr(0640)}}},
	}
